...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        # Dla wszystkich site'ów: pokazujemy liczbę sukcesów dla każdego launch site
        ...
        # Dla wybranego site'u: liczymy sukcesy i porażki
...
def get_scatter_plot(entered_site, payload_range):
    ...
    # Filtracja danych po zakresie payload
    filtered_df = spacex_df[(spacex_df['Payload Mass (kg)'] >= low) & 
                            (spacex_df['Payload Mass (kg)'] <= high)]
    
    if entered_site == 'ALL':
        # Scatter plot dla wszystkich launch sites
        fig = px.scatter(
            ...
            hover_data=['Launch Site']  # pokaż launch site po najechaniu
        )
    else:
        # Scatter plot dla wybranego launch site
